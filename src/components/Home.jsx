  ...
  return (
    <div name="home" className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[800px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className=' text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Yeon Kim</h1>
            <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>I'm a Full Stack Developer.</h2>
            <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a full-stack developer specializing in building (and occatioally designing) exeptional digital experiences. Currently, I'm focused on building responsive full-stack web applications.</p>
            <div>
